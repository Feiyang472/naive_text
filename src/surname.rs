...
pub const SINGLE_SURNAMES: &[char] = &[
    ...
    '顧', '侯', '邵', '孟', '龍', '萬', '段', '雷', '錢', '湯',
    '尹', '黎', '易', '常', '武', '喬', '賀', '賴', '龔', '文',
    // Surnames especially prominent in Six Dynasties texts
    '庾', '桓', '殷', '荀', '裴', '虞', '褚', '柳', '阮', '嵇',
    '顏', '溫', '祖', '竇', '苻', '姬', '翟', '左', '伏', '卞',
    '鮑', '華', '廉', '管', '路', '嚴', '解', '耿', '宗', '甘',
    '臧', '樊', '和', '費', '甄', '辛', '雍', '蘭', '單', '穆',
...
/// Check if a character is a known single-character surname.
pub fn is_known_surname(ch: char) -> bool {
    SINGLE_SURNAMES.contains(&ch)
}
